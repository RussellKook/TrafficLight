...
LEDTask(void *pvParameters)
{
    ...
    while(1)
    {
        x = ui32WakeTime / portTICK_RATE_MS;
        printf("index = %i\n", g_ui8ColorsIndx);
        printf("WakeTime = %i\n", x);
        //
        ...
        {
            //UPDATED TASK if left button, turn on blue LED
            ...
            */
            //UPDATED if right button, turn on red LED
        ...
        //vTaskDelayUntil(&ui32WakeTime, mainLED_TOGGLE_RATE);
